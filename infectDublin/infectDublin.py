...
figPath = (os.path.join('/home/mimbele/PycharmProjects/pythonProject/infectDublin/infectDublin_graph.jpg'))
plt.savefig(figPath)
plt.close()
...
figPath = (os.path.join('/home/mimbele/PycharmProjects/pythonProject/infectDublin/infectDublin_degreeCentrality.jpg'))
plt.savefig(figPath)
plt.close()
...
figPath = (os.path.join('/home/mimbele/PycharmProjects/pythonProject/infectDublin/infectDublin_closenessCentrality.jpg'))
plt.savefig(figPath)
plt.close()
...
figPath = (os.path.join('/home/mimbele/PycharmProjects/pythonProject/infectDublin/infectDublin_betweennessCentrality.jpg'))
plt.savefig(figPath)
plt.close()
